...
const CourseLearningCyberSecurityIntermediate: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello! I am your personal cyber security teacher for intermediate topics. Ask me about advanced security concepts, threat analysis, or hands-on techniques!' }
  ]);
  ...
  return (
    <div className="flex bg-[#121212] text-white overflow-hidden font-sans" style={{ height: '100vh', zoom: '80%' }}>
      {/* Sidebar */}
      <Sidebar 
         activeTab={activeTab} 
