...
export const FluidParticlesBackground = ({
  ...
  // Use a ref to store the noise object to avoid recreating it
  ...
  useEffect(() => {
    ...
    const animate = () => {
      // Hardcoded dark theme for this project
      const isDark = true; 
      ...
      for (const particle of particles) {
        ...
        const n = noiseRef.current.simplex3(
  ...
  return (
    <div
      className={cn(
        "absolute inset-0 w-full h-full overflow-hidden bg-black z-0 pointer-events-none",
        className,
      )}
    >
